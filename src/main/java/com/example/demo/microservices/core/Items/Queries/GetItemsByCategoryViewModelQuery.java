...
@Service
public class GetItemsByCategoryViewModelQuery implements IQuery {

		
	 private int categoryId;
	
	 public GetItemsByCategoryViewModelQuery()
	 {
		
	 }
	 
	 public GetItemsByCategoryViewModelQuery(int categoryId)
	 {
